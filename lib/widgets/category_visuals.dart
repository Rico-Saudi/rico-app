...
class CategoryVisuals {
  ...
  static const Map<String, IconData> icons = {
    ...
    'phone_repair': Icons.phonelink_setup_rounded,
    'appliance_repair': Icons.home_repair_service_rounded,
    'maintenance_centre': Icons.build_rounded,
    'oil_change': Icons.oil_barrel_rounded,
    'money_exchange': Icons.currency_exchange_rounded,
    'tailor': Icons.design_services_rounded,
    'butcher': Icons.kebab_dining_rounded,
    'cosmetics': Icons.brush_rounded,
    'hardware_store': Icons.hardware_rounded,
    'auto_parts': Icons.settings_rounded,
    'sporting_goods': Icons.sports_soccer_rounded,
    'optician': Icons.visibility_rounded,
    'cinema': Icons.local_movies_rounded,
    'amusement': Icons.attractions_rounded,
    'post_office': Icons.local_post_office_rounded,
    'police': Icons.local_police_rounded,
    'government_office': Icons.apartment_rounded,
  };
